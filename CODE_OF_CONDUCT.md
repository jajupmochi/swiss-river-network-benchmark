...
This Code of Conduct applies within all community spaces — GitHub issues and pull
requests, mailing lists, Hugging Face discussions, and any other project-related venue —
and also applies when an individual is officially representing the community in public
spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the
community leaders at **linlin.jia@unibe.ch**. All complaints will be reviewed and
...
available at [v2.1/code_of_conduct][v2.1].
